...
初始 4 名幸存者。坠毁舱初始库存:应急口粮 ×12、藻种 ×20、满气瓶 ×8(教学与前三日的缓冲,也是配方可达性校验的合法起点之一,见 `04`)。后续来源:孵化舱建筑(消耗食物与星币周期产出 1 人)、商盟购买的殖民者合同、脚本救援事件(每局一次)。
...
| 需求 | 满值 | 消耗 | 归零后果 |
|---|---|---|---|
| 氧气 | 100 | 舱内:6 氧/游戏时,由氧气网络供给;舱外:消耗随身气瓶,1.2 氧/真实分钟,气瓶容量 30 氧,空瓶自动返回空气充装站换瓶 | 进入濒危:5 游戏分钟后死亡 |
| 水 | 100 | 100/游戏日,在食堂或宿舍饮水补满 | 濒危同上 |
| 食物 | 100 | 100/游戏日,在食堂进食补满;无食堂时就地吃应急口粮 | 濒危同上 |
| 睡眠 | 100 | 100/16 游戏时;低于 20 强制回床位 | 昏倒原地 2 游戏时,士气 -15 |
| 体温 | 100 | 舱外夜间或极寒星体 -2/真实分钟(保温服减半);舱内与加热范围内回复 +5/真实分钟 | 濒危同上 |

濒危状态:头顶红色图标 + 全局告警;被医疗舱救治或需求回补即解除。死亡永久,尸体需搬运掩埋(士气事件)。
