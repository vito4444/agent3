...
put('life_support_1','make_b_water_purifier','make_b_greenhouse','make_b_electrolyzer','make_b_gas_pylon','make_b_gas_tank','make_b_air_charging_station','make_oxygen_bottle')
