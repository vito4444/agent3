...
put('powered_processing','make_repair_gel','make_b_crusher','make_b_furnace','make_b_roll_mill','make_b_press','smelt_iron','smelt_copper','smelt_silicon','form_copper_mesh','form_aluminum_pipe')
...
put('forming_basic','make_b_wire_mill','form_iron_plate','form_iron_rod','form_iron_gear','form_iron_brick','form_iron_mesh','form_copper_plate','form_copper_wire','form_steel_plate','form_steel_rod','form_steel_gear','form_steel_pipe','form_steel_mesh','make_rivet_set')
...
put('metallurgy_2','electrolyze_bauxite','smelt_nickel','smelt_rare_earth','alloy_bronze','alloy_invar','form_invar_plate','form_invar_pipe','form_invar_gear','form_electrical_steel_plate','form_bronze_plate')
...
put('machining_tech','make_machined_parts','make_gear_assembly','make_control_console','make_small_nozzle','make_valve','make_pump','form_titanium_wire','form_nickel_wire','form_platinum_wire','form_titanium_mesh','form_invar_mesh')
